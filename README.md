...
It is a small Astro static site for maintainer notes, project pages, and reflective posts. Content is written in Markdown/MDX and deployed to GitHub Pages with GitHub Actions.
